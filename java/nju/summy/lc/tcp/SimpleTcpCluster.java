...
import nju.summy.lc.CatalinaCluster;
import nju.summy.lc.ClusterListener;
import nju.summy.lc.ClusterManager;
import nju.summy.lc.ClusterMessage;
import nju.summy.lc.ClusterValve;
import nju.summy.lc.session.ClusterSessionListener;
import nju.summy.lc.session.DeltaManager;
import nju.summy.lc.session.JvmRouteBinderValve;
import nju.summy.lc.session.SessionMessage;
...
public class SimpleTcpCluster extends LifecycleMBeanBase
    ...
    private nju.summy.lc.ClusterDeployer clusterDeployer;
     ...
     *
     * @see nju.summy.lc.CatalinaCluster#addClusterListener(nju.summy.lc.ClusterListener)
     */
    @Override
     ...
     *
     * @see nju.summy.lc.CatalinaCluster#removeClusterListener(nju.summy.lc.ClusterListener)
     */
    @Override
     ...
     */
    @Override
    public nju.summy.lc.ClusterDeployer getClusterDeployer() {
    ...
    public void setClusterDeployer(
            nju.summy.lc.ClusterDeployer clusterDeployer) {
    ...
    public synchronized Manager createManager(String name) {
        ...
        try {
            ...
            log.error("Unable to clone cluster manager, defaulting to nju.summy.lc.session.DeltaManager", x);
            manager = new nju.summy.lc.session.DeltaManager();
        } finally {
     ...
     * Get Manager
     *
     * @see nju.summy.lc.CatalinaCluster#getManager(java.lang.String)
     */
    @Override
     ...
     * @see nju.summy.lc.deploy.FarmWarDeployer#backgroundProcess()
     * @see org.apache.catalina.tribes.group.GroupChannel#heartbeat()
     ...
     *
     * @see nju.summy.lc.CatalinaCluster#send(nju.summy.lc.ClusterMessage)
     */
    @Override
